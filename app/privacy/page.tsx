          ...
          <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
              ...
              <section className="mt-8">
                <h2 className="text-2xl font-semibold pt-6 mb-4">
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>
                    ...
                    If you represent a company, we may collect your company
                    name, address, and other relevant data.
                  </li>
                  <li>
                    <span className="font-semibold">Freight Information:</span>{" "}
                    Details about your shipments, including pickup and delivery
                    addresses, package characteristics, and special
                    instructions.
                  </li>
                  <li>
                    <span className="font-semibold">Usage Data:</span>{" "}
                    Information about how you interact with our website and
                    services, including IP address, browser type, pages visited,
              ...
              <section className="mt-8">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    ...
                    To fulfill your freight transportation orders and manage
                    your shipments.
                  </li>
                  <li>
                    <span className="font-semibold">Communication:</span> To
                    communicate regarding your orders, respond to inquiries, and
                    provide customer support.
                  </li>
                  <li>
                    <span className="font-semibold">Payment and Billing:</span>{" "}
                    To process payments and manage billing for our services.
                  </li>
                  <li>
                    <span className="font-semibold">Service Improvement:</span>{" "}
                    To analyze usage data to enhance our services and improve
                    user experience.
                  </li>
                  <li>
              ...
              <section className="mt-8">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    ...
                    may share your information with trusted third parties who
                    assist us in conducting our business, such as payment
                    processors and logistics partners.
                  </li>
                  <li>
                    <span className="font-semibold">Legal Requirements:</span>{" "}
                    We may disclose your information in response to legal
                    requests or as required by governmental authorities.
                  </li>
                </ul>
              </section>
              <section className="mt-8">
              ...
              <section className="mt-8">
                ...
                <p>
                  ...
                  notify you of any changes by posting the new version of the
