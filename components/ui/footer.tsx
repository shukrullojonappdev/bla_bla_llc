        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="col-span-1">
              ...
              <div className="text-gray-400">
                your reliable partner in the world of logistics! We are ready to
            ...
            <div className="col-span-1 grid">
              ...
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1 text-xl">
                  Address
                </h6>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="text-gray-400 text-sm mr-4">
              &copy; BLA BLA LLC. All rights reserved.
            </div>
          </div>
        </div>
      </div>
